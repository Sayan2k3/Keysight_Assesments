...
public class DataSeeder implements CommandLineRunner {
    ...
    private final com.flightapp.repository.BookingRepository bookingRepository;
    private final Random random = new Random();
    private final String API_KEY = "6c6dfb0c22ab72c4920196dba6574af1";

    public DataSeeder(FlightRepository flightRepository, com.flightapp.repository.BookingRepository bookingRepository) {
        ...
        try {
            ...
            if (response.getBody() != null && response.getBody().getData() != null
                ...
                for (AviationFlightData data : response.getBody().getData()) {
                    ...
                    flight.setAirlineName(data.getAirline() != null && data.getAirline().getName() != null
                            ? data.getAirline().getName()
                            : "Paul's Airline");
    ...
    private void seedManualData() {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            List<String> airlines = Arrays.asList("Indigo", "Air Asia", "Emirates", "Vistara", "Air India",
                    "Qatar Airways");
            flight.setAirlineName(airlines.get(random.nextInt(airlines.size())));
    ...
    static class AviationFlightData {
        ...
        private AviationAirline airline;
        ...
        public AviationAirline getAirline() {
            return airline;
        }

        public void setAirline(AviationAirline airline) {
            this.airline = airline;
        }
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    static class AviationAirline {
        private String name;
